...
final class Mi_Cuadrante_Control_Horas
{
    ...
    public function shortcode_dashboard(array $atts = []): string
    {
        ...
        <div class="mcch-wrap mcch-shortcode-dashboard">
            <?php $this->render_dashboard_content($period['month'], $period['year'], $entries, $summary, $schedule_summary, $period_balance, $edit_entry, false, $target_user_id, true); ?>
        </div>
        <?php
    ...
    private function render_dashboard_content(
        ...
        <section class="mcch-card">
            ...
            <?php $this->render_entries_table($entries, $show_actions, $target_user_id); ?>
        </section>
        <?php
    }
